...
- (void) viewDidLoad
{
    ...
    _swipeView = [[SwipeView alloc] initWithFrame:CGRectMake(0.0f, 0.0f, self.view.frame.size.width, self.view.frame.size.height)];
    ...
    LNBRippleEffect *rippleEffect = [[LNBRippleEffect alloc]initWithImage:[UIImage imageNamed:@"avatar"] Frame:CGRectMake((self.view.frame.size.width/2)-50 ,
              self.view.frame.size.height/2 - 50, 100, 100) Color:[UIColor colorWithRed:(28.0/255.0) green:(212.0/255.0) blue:(255.0/255.0) alpha:1] Target:@selector(buttonTapped:) ID:self];
